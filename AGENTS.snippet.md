...
For coding, debugging, API/SDK/CLI usage, configuration changes, technical research, data analysis, technical answers, or documentation edits, load and follow `.agents/skills/evidence-first-knowledge-work/SKILL.md` before implementation.
...
Guided execution is mandatory for engineering work, including smaller or less reliable models. Follow the skill's required-reading table and `.agents/skills/evidence-first-knowledge-work/references/guided-development.md`; do not infer an exemption from confidence or change size.
